<template>
    ...
    <div v-else class="flex flex-col gap-6 w-full" v-for="product in products">
        ...
        <div class="flex max-lg:flex-col lg:items-start gap-8 w-full">
            <img :src="`https://cihtcwqrhfzjpftnatlw.supabase.co/storage/v1/object/public/images/products/${product.image}` || 'https://i.pinimg.com/originals/27/b3/0f/27b30fc67f6c322fd2f66dfc545d2f0d.jpg'" alt="" class="w-full lg:w-1/2 aspect-[7/8] object-cover rounded-xl">
    ...
    <div v-if="!isLoading" class="flex flex-col gap-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <NuxtLink :to="`/catalog/product-${product.id}`" class="flex flex-col rounded-xl overflow-hidden shadow-md transition-all duration-500 group hover:-translate-y-2" v-for="product in randomProducts">
                <img :src="`https://cihtcwqrhfzjpftnatlw.supabase.co/storage/v1/object/public/images/products/${product.image}` || 'https://i.pinimg.com/originals/27/b3/0f/27b30fc67f6c322fd2f66dfc545d2f0d.jpg'" alt="" class="w-full aspect-[7/8] object-cover">
